...
<head>
    ...
    <title>@yield('title', 'Login') - Toko Muna POS</title>
                ...
                <div class="flex items-center justify-center z-1">
                    <div class="flex flex-col items-center max-w-xs">
                        <div class="mb-6 flex items-center gap-3">
                            <div class="flex h-14 w-14 items-center justify-center rounded-xl bg-brand-500">
                                <svg class="fill-white" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z" fill=""/>
                                </svg>
                            </div>
                            <span class="text-3xl font-bold text-white">Toko Muna</span>
                        </div>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem Point of Sale modern untuk manajemen toko yang efisien dan terintegrasi.
                        </p>
                    </div>
                </div>
            </div>
