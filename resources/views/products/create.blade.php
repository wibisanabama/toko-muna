...
<div class="w-full">
 ...
 <div class="border-b border-gray-200 px-6 py-4 "><h3 class="text-lg font-semibold text-gray-800 ">Tambah Produk Baru</h3></div>
 <div class="p-6">
 ...
 <input type="text" name="name" value="{{ old('name') }}" required autofocus class=" h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ">
 @error('name')<p class="mt-1 text-sm text-error-500">{{ $message }}</p>@enderror
 </div>
 <div>
 <label class="mb-1.5 block text-sm font-medium text-gray-700 ">SKU / Barcode <span class="text-error-500">*</span></label>
 <input type="text" name="sku" value="{{ old('sku') }}" required class=" h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ">
 ...
 <label class="mb-1.5 block text-sm font-medium text-gray-700 ">Kategori</label>
                    <div class="relative" x-data="{ open: false, selected: '{{ old('category_id') ? ($categories->firstWhere('id', old('category_id'))->name ?? 'Pilih Kategori') : 'Pilih Kategori' }}' }">
                        ...
                        <input type="hidden" name="category_id" x-ref="categoryInput" value="{{ old('category_id') }}">
                    </div>
 </div>
 <div>
 ...
 <input type="number" min="0" name="price" value="{{ old('price') }}" required class=" h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-10 pr-4 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 "></div>
 ...
 <input type="number" min="0" name="stock" value="{{ old('stock', 0) }}" required class=" h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ">
 @error('stock')<p class="mt-1 text-sm text-error-500">{{ $message }}</p>@enderror
 </div>
 <div>
 <label class="mb-1.5 block text-sm font-medium text-gray-700 ">Gambar (Max: 2MB)</label>
 ...
 <textarea name="description" rows="3" class=" w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 ">{{ old('description') }}</textarea>
 </div>
 </div>
